...
window.NHDMV = {
  ...
  services: [
    ...
    { id: 'reg-renew', category: 'vehicle', group: 'registration', name: 'Renew vehicle registration', blurb: 'Pay town/city permit fees first, then state portion at DMV or municipal agent', ways: ['drop', 'appt'], href: 'registration.html' },
    ...
    { id: 'placard', category: 'vehicle', group: 'specialty', name: 'Walking disability placard', blurb: 'Accessible parking placard applications', ways: ['drop', 'appt'], href: 'placard.html' },
  ...
  onlineGuide: [
    ...
    { id: 'reg-renew', title: 'Renew registration', status: 'partial', blurb: 'Town/city fees first, then state portion online or drop box', href: 'registration.html' },
  ...
  serviceDetails: {
    ...
    'reg-renew': {
      ...
      primaryCta: { label: 'Renew registration', href: 'registration.html' },
