      ...
      >
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          <ScreenTitle
            ...
            subtitle="Enter the email for your BioCross account. We'll send a link to choose a new password."
          />
          ...
          {sent ? (
            <InfoCallout
              ...
              body={`If an account exists for ${email.trim()}, a reset link has been sent. Open it on this device to choose a new password.`}
            />
          ) : (
            <>
