        ...
        return (
          <button
            ...
            className={cn(
              ...
              selected
                ? "border-brand-light bg-brand text-white shadow-[0_10px_30px_rgba(255,122,24,0.35)]"
                : "border-white/10 bg-white/5 text-zinc-300 hover:border-brand-light/60 hover:text-white"
            )}
