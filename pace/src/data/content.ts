...
export const paceCardVariants = [
  {
    ...
    state: 'Flow',
    bpm: '156',
    powerTrack: 'Blinding Lights',
    artist: 'The Weeknd',
    sound: 'Alt · Electronic · Indie',
    accent: '#1DB954',
  },
  {
    id: 'starter',
    name: 'Maya Chen',
    personality: 'THE STARTER',
    state: 'Start',
    bpm: '128',
    powerTrack: 'Intro',
    artist: 'The xx',
  ...
  },
  {
    id: 'pusher',
    name: 'Jordan Blake',
    personality: 'THE PUSHER',
    state: 'Push',
    bpm: '168',
    powerTrack: 'Go',
    artist: 'The Chemical Brothers',
    sound: 'Electronic · Dance',
    accent: '#C5FF3D',
  },
  {
    id: 'finisher',
    name: 'Sam Okonkwo',
    personality: 'THE FINISHER',
    state: 'Beat',
    bpm: '171',
    powerTrack: 'Lose Yourself',
    artist: 'Eminem',
    sound: 'Hip-Hop · Anthem',
    accent: '#FF5A36',
  },
]
...
export const playlistCovers = [
  {
    ...
    state: 'Start',
    tracks: 42,
    mood: 'Warm openers · building BPM',
  },
  {
    id: 'pl-flow',
    title: 'PACE: Flow State',
    subtitle: 'Hold your pace',
    state: 'Flow',
    tracks: 58,
    mood: 'Steady tempo · mid-run fuel',
  },
  {
    id: 'pl-push',
    title: 'PACE: Push',
    ...
    state: 'Push',
    tracks: 36,
    mood: 'Higher energy · denser edits',
  },
  {
    id: 'pl-beat',
    title: 'PACE: Beat',
    ...
    state: 'Beat',
    tracks: 28,
    mood: 'Power songs · final push',
  },
  {
    id: 'pl-recover',
    title: 'PACE: Recover',
    subtitle: 'Bring it down',
    state: 'Recover',
    tracks: 40,
    mood: 'Cooldown · lower BPM',
  },
]

export const deviceMocks = [
  {
    id: 'mock-tiktok',
    platform: 'TikTok',
    format: 'Challenge',
    headline: 'What song makes you run faster?',
    track: 'Losing It — Fisher',
    cta: 'Open playlist on Spotify',
    state: 'Push',
  },
  {
    id: 'mock-story',
    platform: 'Instagram',
    format: 'Story',
    headline: 'My PACE Card just dropped',
    track: 'Power track: Blinding Lights',
    cta: 'Swipe up → Spotify',
    state: 'Beat',
  },
  {
    id: 'mock-feed',
  ...
  },
  {
    ...
    platform: 'YouTube',
    format: 'Thumbnail',
    headline: 'First 5K: music diary',
    track: 'Playlist chapters inside',
    cta: 'Watch',
    state: 'Beat',
  },
  {
    ...
    format: 'Ad',
    headline: 'Your run already has a soundtrack.',
    track: 'Discover music that fits how you run',
    cta: 'Open Spotify',
    state: 'Start',
  },
]
