  ...
  return (
    <main id="main-content" className="pb-20 pt-28 sm:pb-28 sm:pt-36">
      ...
      <div className="section-shell max-w-3xl">
        ...
        <dl className="mt-8 grid gap-4 rounded-[1.5rem] border border-ink/8 bg-white p-5 sm:grid-cols-3">
          <div>
            <dt className="font-sans text-[0.65rem] font-semibold uppercase tracking-[0.16em] text-cobalt-600">
              Role
            </dt>
            <dd className="mt-2 font-sans text-sm leading-relaxed text-ink/70">
              Product design, brand narrative, interaction design, and front-end build
            </dd>
          </div>
          <div>
            <dt className="font-sans text-[0.65rem] font-semibold uppercase tracking-[0.16em] text-cobalt-600">
          ...
          <div>
            ...
            <dd className="mt-2 font-sans text-sm leading-relaxed text-ink/70">
              Campaign, guided product journey, onboarding + plan matrix, Find Your Year, case study
            </dd>
          </div>
        </dl>
      </div>
