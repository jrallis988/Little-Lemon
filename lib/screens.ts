...
export const SCREENS: ScreenDef[] = [
  ...
  { id: 42, code: "42", name: "Video player", surface: "app", route: "/app/workouts/[id]", status: "live" },
  { id: 43, code: "43", name: "PF+ collections", surface: "app", route: "/app/workouts", status: "live" },
  { id: 44, code: "44", name: "Favorites", surface: "app", route: "/app/workouts/[id]", status: "live" },
  { id: 45, code: "45", name: "Workout history", surface: "app", route: "/app/workouts/[id]", status: "live" },
  { id: 46, code: "46", name: "Guide step-through", surface: "app", route: "/app/workouts/[id]", status: "live" },
  { id: 47, code: "47", name: "Form tutorial", surface: "app", route: "/app/workouts/[id]", status: "live" },
  { id: 48, code: "48", name: "Workout complete", surface: "app", route: "/app/workouts/[id]", status: "live" },
  ...
  { id: 62, code: "62", name: "Perk redeem", surface: "app", route: "/app/perks/[id]", status: "live" },
