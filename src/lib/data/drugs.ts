...
export const DRUGS: Drug[] = [
  ...
  },
  {
    ...
    strengths: [
      { id: "oze-0-25", label: "0.25 mg / 0.5 mg pen", amountMg: 0.25, form: "injection" },
      { id: "oze-1", label: "1 mg pen", amountMg: 1, form: "injection" },
    ],
    commonQuantities: [1],
    retailCashPrice30: 1028,
    retailCashPrice90: 1028,
    searchAliases: ["ozempic", "semaglutide", "glp-1", "diabetes weight"],
  },
  {
    ...
    strengths: [
      { id: "weg-0-25", label: "0.25 mg pen", amountMg: 0.25, form: "injection" },
      { id: "weg-1", label: "1 mg pen", amountMg: 1, form: "injection" },
      { id: "weg-2-4", label: "2.4 mg pen", amountMg: 2.4, form: "injection" },
    ],
    commonQuantities: [1],
    retailCashPrice30: 1349,
    retailCashPrice90: 1349,
    searchAliases: ["wegovy", "weight loss", "semaglutide wegovy"],
  },
  {
    id: "tirzepatide",
    brandName: "Zepbound",
    ...
    strengths: [
      { id: "zep-2-5", label: "2.5 mg pen", amountMg: 2.5, form: "injection" },
      { id: "zep-5", label: "5 mg pen", amountMg: 5, form: "injection" },
      { id: "zep-10", label: "10 mg pen", amountMg: 10, form: "injection" },
    ],
    commonQuantities: [1],
    retailCashPrice30: 1087,
    retailCashPrice90: 1087,
    searchAliases: ["zepbound", "mounjaro", "tirzepatide", "weight"],
  },
  {
    id: "apixaban",
    brandName: "Eliquis",
    ...
    strengths: [
      { id: "eli-2-5", label: "2.5 mg tablet", amountMg: 2.5, form: "tablet" },
      { id: "eli-5", label: "5 mg tablet", amountMg: 5, form: "tablet" },
    ],
    commonQuantities: [60, 180],
    retailCashPrice30: 620,
    retailCashPrice90: 1750,
    searchAliases: ["eliquis", "blood thinner", "apixaban"],
  },
];
