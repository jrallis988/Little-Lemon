...
const actions = [
  ...
  {
    title: "Give to keep hubs open",
    copy: "Support drop-in spaces, creative labs, and stability navigation so every young person can walk in without fees or red tape.",
    cta: "See how to give",
    to: "/donate",
    primary: false,
