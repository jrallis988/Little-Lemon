...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-navy text-cream shadow-soft hover:bg-navy-deep active:scale-[0.98]",
        secondary:
          "bg-sage-soft text-sage-deep hover:bg-sage/20 active:scale-[0.98]",
        ghost: "hover:bg-navy/5 text-navy",
        outline:
          "border border-border bg-white/70 text-navy hover:bg-white active:scale-[0.98]",
        soft: "bg-white/80 text-navy shadow-soft hover:bg-white",
      },
      size: {
