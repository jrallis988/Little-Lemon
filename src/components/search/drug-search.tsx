...
export function DrugSearch({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex overflow-hidden border bg-card transition-shadow focus-within:ring-3 focus-within:ring-ring/40",
          isHero
            ? "flex-col border-transparent shadow-[0_12px_40px_-12px_rgba(8,24,48,0.45)] sm:flex-row"
            : "items-stretch border-border shadow-sm"
        )}
      >
        ...
        <Button
          ...
          className={cn(
            ...
            isHero
              ? "m-0 h-12 w-full rounded-none px-6 text-lg sm:m-1.5 sm:w-auto sm:min-w-[7.5rem] sm:rounded-md"
              : "m-1.5 rounded-md px-5"
          )}
        >
          {pending ? (
