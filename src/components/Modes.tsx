...
export function Modes() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute -right-24 top-10 h-72 w-72 rounded-full bg-cobalt-600/30 blur-3xl"
        aria-hidden="true"
      />
      <div
        className="pointer-events-none absolute -left-16 bottom-0 h-64 w-64 rounded-full bg-tide/20 blur-3xl"
        aria-hidden="true"
      />
      ...
      <div className="section-shell relative">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
          <div>
            ...
            <p className="mt-4 max-w-lg font-serif text-lg leading-relaxed text-white/65 sm:text-xl">
          ...
          <div className="rounded-[1.75rem] border border-white/10 bg-white/5 p-6 backdrop-blur-sm sm:p-8">
            <p className="font-sans text-xs font-semibold uppercase tracking-[0.18em] text-white/45">
              Structure level
            </p>
                ...
                return (
                  <button
                    ...
                    className={`w-full rounded-2xl px-4 py-4 text-left transition ${
                      selected ? "bg-white text-ink" : "bg-transparent text-white hover:bg-white/5"
                    }`}
                  >
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <span
                        className={`font-sans text-xs font-semibold ${
                          selected ? "text-cobalt-700" : "text-white/40"
                        }`}
                      >
                        {mode.level}%
                      </span>
                    ...
                    <p
                      className={`mt-3 font-sans text-sm leading-relaxed ${
                        selected ? "text-ink/65" : "text-white/55"
                      }`}
                    >
                      {mode.detail}
                    </p>
