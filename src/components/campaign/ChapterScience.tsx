...
export function ChapterScience() {
  return (
    <section id="science" className="relative overflow-hidden bg-ink py-20 text-white sm:py-28" aria-labelledby="science-heading">
      ...
      <div className="section-shell relative">
        ...
        <p className="mt-4 max-w-2xl font-serif text-lg leading-relaxed text-white/70 sm:text-xl">
          Nutrition, behavior, habits, activity, personalization, and modern medical support—including
          GLP-1—presented as one continuous evolution.
        </p>
