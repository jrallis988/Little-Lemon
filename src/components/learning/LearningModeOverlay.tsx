    ...
    <>
      {visible && !settled && (
        ...
        >
          <div className="glass-panel mx-6 max-w-md rounded-3xl px-8 py-10 text-center animate-rise-in">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-navy-mist text-ocean">
      ...
      {settled && (
        <button
          ...
          className={cn(
            "fixed bottom-20 right-4 z-40 flex h-11 w-11 items-center justify-center rounded-2xl bg-navy text-foam shadow-soft transition hover:scale-105 md:bottom-6",
            "animate-fade-in",
          )}
