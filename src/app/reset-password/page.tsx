  ...
  return (
    <main id="main-content" className="flex min-h-screen items-center justify-center bg-[#e9eef4] px-4 py-12">
      <section className="mp-card w-full max-w-md p-6">
        ...
        <h1 className="mt-4 text-3xl font-black text-[#0f2744]">Reset password</h1>
        <p className="mt-2 text-sm text-[#5b6b7c]">
          Enter your account email and we will show the mock reset confirmation.
        </p>

        {sentTo ? (
          <div className="mt-6 rounded-[4px] border border-[#1f7a4d]/30 bg-[#1f7a4d]/10 p-4">
            <h2 className="font-black text-[#0f2744]">Reset link sent</h2>
