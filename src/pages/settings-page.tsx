  ...
  return (
    <div
      className={cn(
        ...
        isMobile ? 'pb-24 text-white' : 'px-4 py-6 md:px-8',
      )}
    >
      {isMobile ? (
        <MobileScreenHeader
      ...
      <div className={cn('grid max-w-3xl gap-4', isMobile ? 'mt-1 px-4' : 'mt-8')}>
        <section className={cn(isMobile ? 'mobile-card p-5' : 'rounded-3xl border border-[var(--border-subtle)] bg-[var(--color-surface-elevated)] p-5')}>
        ...
        <section className={cn(isMobile ? 'mobile-card p-5' : 'rounded-3xl border border-[var(--border-subtle)] bg-[var(--color-surface-elevated)] p-5')}>
          ...
          <ul className={cn('mt-3 space-y-2 text-sm', isMobile ? 'text-white/65' : 'text-[var(--text-secondary)]')}>
            {memories.slice(0, 5).map((memory) => (
              ...
              >
                <span className={cn('text-xs uppercase', isMobile ? 'text-white/40' : 'text-[var(--text-muted)]')}>
                  {memory.kind}
                </span>
                <p>{memory.content}</p>
              </li>
