    ...
    <>
      <section className="page-hero compact">
        ...
        <div className="container page-hero-content">
          ...
          <p>
            Reach admissions, ask a question, or plan a visit to our Portsmouth
            campus.
          </p>
        </div>
      </section>
          ...
          <div className="contact-details">
            ...
            <div className="detail-block">
              ...
              <p className="fine-print">
                Monday to Friday the building closes after the last class is
                dismissed.
              </p>
            </div>
          </div>
          ...
          <div className="contact-form-wrap">
            {submitted ? (
              <div className="form-success" role="status">
                <h3>Message sent.</h3>
                <p>
                  Thanks for reaching out. A member of the Great Bay team will
